...
(function ($) {
	var defaults = {
		...
		navBtnIcon: '<img src="assets/img/line-menu.svg" height="18" width="18" alt="">',

		//** Иконка кнопки, которая вызывает модальное окно с формой обратного звонка
		callFormBtnIcon: '<img src="assets/img/phone.svg" height="18" width="18" alt="">',

		//** Иконка кнопки, которая вызывает модальное окно с формой отправки сообщения
		requestFormBtnIcon: '<img src="assets/img/envelope.svg" height="18" width="18" alt="">',
		...
		callFormIcon: 'assets/img/call.svg',
		...
		requestFormIcon: 'assets/img/mail.svg',
